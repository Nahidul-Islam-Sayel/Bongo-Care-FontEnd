...
import siubd from '../image/Logo.jpg';
import "./Login.css";
const Login = () => {
  ...
  const[profileAdmin,setProfilAdmin]= useState(false);
    ...
    const userSubmit=(e)=>{
      ...
      .then(res=>((res.data.error)? setVisibleR(true) : (setVisible(true), setProfile(true),  sessionStorage.setItem('username', username),sessionStorage.setItem('normaluser', username),setLogin(1),sessionStorage.setItem("Token",res.data.access_token),console.log(res))));
    ...
    const userSubmitDoc=(e)=>{
      ...
      .then(res=>((res.data.error)? setVisibleR(true): (setVisible(true), setProfileDoc(true),  sessionStorage.setItem('username', username),setDocLogin(1),sessionStorage.setItem('doctor', true),sessionStorage.setItem("Token",res.data.access_token),console.log(res))));
    ...
    const userAdmin=(e)=>{
      ...
      .then(res=>((res.data.error)? setVisibleR(true) :( setVisible(true),setAdminLogin(1),setProfilAdmin(true),console.log(res),sessionStorage.setItem('Admin', true),sessionStorage.setItem('admin', true),sessionStorage.setItem("Token",res.data.access_token))));
  ...
  return (
   ...
   <div
    ...
    >
        <div
            class="p-4 py-6  flex items-center justify-center text-white bg-blue-950 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
        ...
        { (isUsers &&!isDoctors&& !DiagnosticCenter)&& <div class="p-5 bg-white md:flex-1">
            <h3 class="my-4 text-2xl font-semibold text-gray-700">User Login</h3>
                ...
                <div class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        >
                            ...
                            <span class="text-sm font-medium text-gray-800 group-hover:text-white"  onClick={()=>  {setIsDoctor(true) ; setIsUsers(false) ;setDiagnosticCenter(false)}}>Login As A Doctor</span>
                        </a>
                        <a
                            href="#"
                        ...
                        >
                            ...
                            <span class="text-sm font-medium text-blue-500 group-hover:text-white"  onClick={()=>  {setIsDoctor(false) ; setIsUsers(false);setDiagnosticCenter(true)}}>Log In As A Admin</span>
                        </a>
        ...
        {(!isUsers && isDoctors&& !DiagnosticCenter)&& <div class="p-5 bg-white md:flex-1">
            <h3 class="my-4 text-2xl font-semibold text-gray-700">Doctor</h3>
                ...
                <div class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        >
                            ...
                            <span class="text-sm font-medium text-gray-800 group-hover:text-white"    onClick={()=>  {setIsDoctor(false) ; setIsUsers(true); setDiagnosticCenter(false)}} >Log In As A User</span>
                        </a>
                        <a
                            href="#"
                            class="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-blue-500 rounded-md group hover:bg-blue-500 focus:outline-none"
        ...
        { (!isUsers &&!isDoctors&& DiagnosticCenter)&& <div class="p-5 bg-white md:flex-1">
            <h3 class="my-4 text-2xl font-semibold text-gray-700">Admin</h3>
            <form action="#" class="flex flex-col space-y-5">
                <div class="flex flex-col space-y-1">
                    <label for="email" class="text-sm font-semibold text-gray-500">User Name</label>
                    <input
                ...
                <div class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        >
                            ...
                            <span class="text-sm font-medium text-blue-500 group-hover:text-white"   onClick={()=>  {setIsDoctor(false) ; setIsUsers(true); setDiagnosticCenter(false)}}>Login as a User</span>
                        </a>
